# XAMPP Stuff NOW WITH EC2 CONNECTIONS
...
The main thing running on the EC2 is the python script that is used to average the scores to upload to the database