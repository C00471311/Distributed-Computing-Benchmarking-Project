      ...
      <div style="display:grid; grid-template-columns:1fr 320px; gap:24px;">
        <div>
          <div class="card" style="margin-bottom:16px;">
            ...
            <p style="font-size:13px; color:var(--text-muted); margin-bottom:16px;">
              Choose a suggestion or type your exact model.
            </p>
          ...
          <div class="card" style="margin-bottom:16px;">
            ...
            <p style="font-size:13px; color:var(--text-muted); margin-bottom:20px;">
              Enter scores for benchmarks you’ve run.
            </p>
        ...
        <div style="display:flex;flex-direction:column;gap:16px;">
          <div class="total-score-display">
            ...
            <div class="sub">Preview only. Official score is calculated by EC2.</div>
          </div>
              ...
              <?php foreach (benchmark_labels() as $key => $label): ?>
                <div>
                  <div style="display:flex;justify-content:space-between;font-size:13px;margin-bottom:4px;">
                    <span><?= e($label) ?></span>
                    <span class="score-val" id="val-<?= e($key) ?>" style="font-size:13px;">0</span>
                  </div>
                  <div class="score-bar-track">
                    <div class="score-bar-fill" id="bar-<?= e($key) ?>" style="width:0%"></div>
                  </div>
                </div>
              <?php endforeach; ?>
            </div>
